...
We’re a 501c3 nonprofit in the United States, so donations to us are tax deductible. Virtually all of our donations have been and will be spent on developers, not overhead. Our work has the capability to make engineers and researchers in industry and academia alike substantially more productive and make entirely new things feasible to accomplish, as well as dramatically lowering the barrier for new students entering the field. We have various [perks](https://farama.org/donations) for individuals or companies who donate larger sums. _If you want to see our vision come to light, please [donate](https://farama.org/donations) to the future of AI._
