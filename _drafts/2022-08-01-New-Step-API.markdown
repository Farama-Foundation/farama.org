...
date: "2023-10-23"
excerpt: "In-depth explanation of the "terminated" and "truncated" values in Gymnasium's Env.step API, and their context in RL theory."
---
...
In this post, we explain the motivation for the API change, why alternative implementations were not selected, and the relation to RL theory. 
